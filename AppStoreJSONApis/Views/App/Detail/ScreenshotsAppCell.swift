...
class ScreenshotCell: UnderlineCell {
    ...
    override init(frame: CGRect) {
        ...
        scrHorizontalCollection.view.anchor(top: previewLabel.bottomAnchor, leading: leadingAnchor, bottom: bottomAnchor, trailing: trailingAnchor, padding: .init(top: 20, left: 0, bottom: 20, right: 0))
